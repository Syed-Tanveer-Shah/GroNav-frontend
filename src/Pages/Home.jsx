...
import HeroSearch from "./include/HeroSearch";
                                        ...
                                        filteredProducts.map((item) => (
                                            ...
                                            <div className="col-xl-3 col-md-6 col-sm-12 col-12">
                                                <div className="single-shopping-card-one tranding-product">
                                                    <div className="thumbnail-preview" onClick={() => navigate(`/product/${item.id}`)} style={{cursor:'pointer'}}>
                                                        <img src={item.image} alt="grocery" loading="lazy" width="200" height="200" onError={(e) => { e.target.src = '/placeholder.png'; }} />
                                                    </div>
                                                            ...
                                                            {item.discount_active ? (
                                                                <div className="bd-product__price">
                                                                    <span className="bd-product__old-price">
                                                                        <del className="text-danger"><strong> {convertPrice(item.price)} </strong></del>
                                                                    </span>
                                                                    <span className="bd-product__new-price">
                                                                        <strong> {convertPrice(item.discounted_price)}</strong>
                                                                    </span>
                                                                </div>
                                                            ) : (
                                                                <div className="bd-product__price">
                                    ...
                                    <div className="col-xl-4 col-lg-12">
                                        <Link to="/product-list" className="single-discount-with-bg">
                                            <div className="inner-content">
                                                ...
                                                <div className="price-area">
                                                    <span>Only</span>
                                                    <h4 className="title">{convertPrice(15)}</h4>
                                                </div>
                                            </div>
                                        </Link>
